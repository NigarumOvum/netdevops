...
class HTTPServersController(BaseController):
    ...
    def create_network_http_server(self,
        ...
        self.validate_parameters(network_id=options.get("network_id"),
                                 create_network_http_server=options.get("create_network_http_server"))
    ...
    def create_network_http_servers_webhook_test(self,
        ...
        # Validate required parameters
        self.validate_parameters(network_id=options.get("network_id"),
                                 create_network_http_servers_webhook_test=options.get("create_network_http_servers_webhook_test"))
