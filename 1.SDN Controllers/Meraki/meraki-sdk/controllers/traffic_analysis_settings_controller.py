...
class TrafficAnalysisSettingsController(BaseController):
    ...
    def update_network_traffic_analysis_settings(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    update_network_traffic_analysis_settings --
                        UpdateNetworkTrafficAnalysisSettingsModel -- TODO:
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_traffic_analysis_settings')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
