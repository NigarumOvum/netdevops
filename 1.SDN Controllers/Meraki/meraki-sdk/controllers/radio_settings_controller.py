...
class RadioSettingsController(BaseController):
    ...
    def create_network_wireless_rf_profile(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    create_network_wireless_rf_profile --
                        CreateNetworkWirelessRfProfileModel -- TODO: type
        ...
        # Validate required parameters
        self.validate_parameters(network_id=options.get("network_id"),
                                 create_network_wireless_rf_profile=options.get("create_network_wireless_rf_profile"))
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('create_network_wireless_rf_profile')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def update_network_wireless_rf_profile(self,
        ...
        Args:
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    network_id -- string -- TODO: type description here.
                        Example: 
                    rf_profile_id -- string -- TODO: type description here.
                        Example: 
                    update_network_wireless_rf_profile --
                        UpdateNetworkWirelessRfProfileModel -- TODO: type
                        description here. Example: 
        ...
        # Validate required parameters
        self.validate_parameters(network_id=options.get("network_id"),
                                 rf_profile_id=options.get("rf_profile_id"))

        # Prepare query URL
        _url_path = '/networks/{networkId}/wireless/rfProfiles/{rfProfileId}'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'networkId': options.get('network_id', None),
            'rfProfileId': options.get('rf_profile_id', None)
        })
        _query_builder = Configuration.base_uri
        _query_builder += _url_path
        _query_url = APIHelper.clean_url(_query_builder)
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_wireless_rf_profile')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
