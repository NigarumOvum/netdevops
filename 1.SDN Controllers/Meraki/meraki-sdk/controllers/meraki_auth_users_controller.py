...
class MerakiAuthUsersController(BaseController):
    ...
    def get_network_meraki_auth_user(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    network_id -- string -- TODO: type description here.
                        Example: 
                    meraki_auth_user_id -- string -- TODO: type description
                        here. Example: 
        ...
        self.validate_parameters(network_id=options.get("network_id"),
                                 meraki_auth_user_id=options.get("meraki_auth_user_id"))

        # Prepare query URL
        _url_path = '/networks/{networkId}/merakiAuthUsers/{merakiAuthUserId}'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'networkId': options.get('network_id', None),
            'merakiAuthUserId': options.get('meraki_auth_user_id', None)
        })
        _query_builder = Configuration.base_uri
        _query_builder += _url_path
        _query_url = APIHelper.clean_url(_query_builder)
