...
class MXWarmSpareSettingsController(BaseController):
    ...
    def update_network_warm_spare_settings(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    update_network_warm_spare_settings --
                        UpdateNetworkWarmSpareSettingsModel -- TODO: type
        ...
        self.validate_parameters(network_id=options.get("network_id"),
                                 update_network_warm_spare_settings=options.get("update_network_warm_spare_settings"))
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_warm_spare_settings')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
