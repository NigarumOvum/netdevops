...
class SwitchPortSchedulesController(BaseController):
    ...
    def create_network_switch_port_schedule(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    create_network_switch_port_schedule --
                        CreateNetworkSwitchPortScheduleModel -- TODO: type
        ...
        self.validate_parameters(network_id=options.get("network_id"),
                                 create_network_switch_port_schedule=options.get("create_network_switch_port_schedule"))
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('create_network_switch_port_schedule')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def update_network_switch_port_schedule(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    update_network_switch_port_schedule --
                        UpdateNetworkSwitchPortScheduleModel -- TODO: type
                        description here. Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_switch_port_schedule')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
